...
var (
	...
	ChainImage = ibc.NewDockerImage("janesh132", "local", "1025:1025")
	...
	DefaultGenesis = []cosmos.GenesisKV{
		...
		cosmos.NewGenesisKV("app_state.poa.params.admins", []string{"mybech2310d07y265gmmuvt4z0w9aw880jnsr700jqtk8xm", "mybech231hj5fveer5cjtn4wd6wstzugjfdxzl0xpu9hsut"}),
