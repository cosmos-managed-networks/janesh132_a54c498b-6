...
#
# Examples:
# CHAIN_ID="local-1" HOME_DIR="~/.janesh132" BLOCK_TIME="1000ms" CLEAN=true sh scripts/test_node.sh
# CHAIN_ID="local-2" HOME_DIR="~/.janesh132" CLEAN=true RPC=36657 REST=2317 PROFF=6061 P2P=36656 GRPC=8090 GRPC_WEB=8091 ROSETTA=8081 BLOCK_TIME="500ms" sh scripts/test_node.sh
...
export HOME_DIR=$(eval echo "${HOME_DIR:-"~/.janesh132"}")
...
from_scratch () {
  ...
  # mybech231efd63aw40lxf3n4mhf7dzhjkr453axurq3y54z
  ...
  # mybech231hj5fveer5cjtn4wd6wstzugjfdxzl0xpu9hsut
  ...
  # poa
  update_test_genesis '.app_state["poa"]["params"]["admins"]=["mybech2310d07y265gmmuvt4z0w9aw880jnsr700jqtk8xm"]'
