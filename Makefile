...
HTTPS_GIT := github.com/mygithub/janesh132.git
...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=janesh132 \
...
ifeq (,$(shell which heighliner))
	...
	heighliner build -c janesh132 --local -f chains.yaml
endif
